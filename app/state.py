...
K_DELIVERY_MODE = "delivery_mode"    # instagram approval, or Telegram-only completion
K_INSTAGRAM_ACCOUNT_ID = "instagram_account_id"  # account the human reviews for
K_TELEGRAM_DELIVERY = "telegram_delivery"  # delivery receipt, or resumable failure
K_TELEGRAM_REVIEW_DELIVERY = "telegram_review_delivery"  # per-bot receipts for one review round
